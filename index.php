...
<head>
    ...
    <style>
        /* variabel warna tema feminin - nyaman dan enak dilihat mata (Blush & Cream) */
        :root {
            --primary: #e0a6b1;      /* soft blush pink */
            --primary-dark: #c28b96; /* darker blush */
            --bg: #fcfaf8;           /* warm cream / off-white */
            --surface: #ffffff;      /* pure white cards */
            --border: #f2e8ea;       /* very soft border */
            --text-main: #5a5254;    /* warm grey, easy on eyes */
            --text-muted: #9e9396;   /* lighter warm grey */
            --sidebar-bg: #fdf8f9;   /* very light blush for sidebar */
            --sidebar-text: #736769; /* soft readable text */
            --sidebar-hover: rgba(224, 166, 177, 0.12);
            --sidebar-active-bg: #f4e8ea; 
            --sidebar-active-text: #bd828e;
        }
        ...
        body {
            ...
            color: var(--text-main);
            /* hapus background pattern agar lebih bersih dan tidak berisik */
        }

        /* sidebar modern minimalis cewe banget */
        .sidebar {
            background: var(--sidebar-bg);
            min-height: 100vh;
            color: var(--sidebar-text);
            padding: 2rem 1.5rem;
            border-right: 1px solid rgba(232, 216, 219, 0.5);
